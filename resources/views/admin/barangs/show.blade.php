    ...
    <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item active" href="{{ route('barang.index') }}">Data Barang</a>
...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="text-center">
                    ...
                    <a class="btn btn-warning" data-toggle="modal" data-target="#editBarangModal">
    ...
    @include('admin.barangs.create')
    @include('admin.barangs.edit')
@endsection
